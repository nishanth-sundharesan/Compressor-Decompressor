...
#### In summary:
 ...
 - The "DeCompressor.c" will read the same file and creates a vert list.
...
Answer: I would say either 10 or 11 bits, because the data would be accurate upto 2 decimal points. But it all depends on the range of the data. For example, if there is a single large floating point value then the accuracy of the entire data will decrease.